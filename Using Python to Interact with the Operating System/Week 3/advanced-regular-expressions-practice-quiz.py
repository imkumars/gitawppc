# Advanced Regular Expressions practice quiz
...
def transform_record(record):
  #new_record = re.sub(r"([A-Za-z, ]*)([0-9-,]*)([A-Za-z ]*)", r"\1+1-\2\3", record)
...
# which is the C single-line comment indicator. For the purpose of this exercise, we'll ignore the
# possibility of a hash mark embedded inside of a Python command, and assume that it's only used to indicate a comment.
...
def convert_phone_number(phone):
  result = re.sub(r"([A-Za-z ]*[^0-9])([0-9]{3})-([0-9]{3})-([0-9]{4})", r"\1(\2) \3-\4", phone)
  return result
